...
A interface interativa do **Swagger** foi projetada para contar a história do fluxo operacional de cima para baixo. Para realizar testes rápidos de ponta a ponta, siga esta exata ordem de execução:
